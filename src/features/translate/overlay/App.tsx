...
const App = () => {
  ...
  return (
    <FormProvider {...form}>
      <form className="flex w-xl flex-col rounded-xl" onSubmit={form.handleSubmit(onSubmit, onErrors)}>
        <div className="mb-4 font-medium text-slate-800 dark:text-white">Translate Preferences</div>
        ...
        <div className="mt-4 flex shrink-0 justify-end gap-4 p-2">
          <button
            type="button"
