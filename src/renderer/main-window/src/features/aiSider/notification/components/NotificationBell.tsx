...
export const NotificationBell = () => {
  ...
  return (
    <button
      ...
      className={clsx(
        ' relative z-1 flex w-full shrink-0 cursor-pointer flex-col items-center justify-center gap-1 rounded-md bg-slate-100 px-0.5 py-1 text-slate-500 transition-colors hover:bg-white hover:text-indigo-500'
      )}
      title="Notifications"
    >
