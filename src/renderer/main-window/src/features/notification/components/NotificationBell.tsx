...
export const NotificationBell = () => {
  ...
  return (
    <button
      ...
      className={clsx(
        " z-1 w-full px-0.5 relative rounded-md flex items-center justify-center cursor-pointer hover:bg-white dark:hover:bg-slate-800 transition-colors text-slate-500 dark:text-slate-400 hover:text-indigo-500 shrink-0 gap-1 flex-col py-1",
      )}
      title="Notifications"
    >
