          ...
          >
            <div className="flex relative">
              ...
              {tab?.audible && !tab?.isMuted && (
                <button
                  className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 cursor-pointer p-0 border-none bg-transparent"
              ...
              {(tab?.blockedNotifications ?? 0) > 0 && (
                ...
                >
                  ...
                  {(tab?.blockedNotifications ?? 0) > 1 && (
                    <span className="text-[8px] font-bold text-orange-500 leading-none">
